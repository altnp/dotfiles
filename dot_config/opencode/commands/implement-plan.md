...
- STOP and reason about why the plan can't be followed.
...
- Run the success criteria checks (for example `dotnet test`, `npm test`, or `make check test` if the repo uses make).
